    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} sm={6} md={3}>
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              <PlayCircleOutline color="primary" sx={{ mr: 1, fontSize: 18 }} />
              <Typography variant="subtitle2" fontWeight="medium">Active Streams</Typography>
            </Box>
        ...
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" fontWeight="medium">Total Viewers</Typography>
            </Box>
            <Typography variant="h4" color="primary" fontWeight="bold" align="center">
        ...
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" fontWeight="medium">Bandwidth</Typography>
            </Box>
        ...
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" fontWeight="medium">Uptime</Typography>
            </Box>
            <Typography variant="h5" color="primary" fontWeight="bold" align="center">
        ...
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" fontWeight="medium">CPU Load</Typography>
            </Box>
            <Typography 
              variant="h4" 
              color={
                (metrics?.cpu_load ?? 0) > 0.8 ? "error" : 
                (metrics?.cpu_load ?? 0) > 0.5 ? "warning" : "success"
              } 
              fontWeight="bold" 
              align="center"
            >
        ...
        <Card sx={{ height: '100px' }}>
          <CardContent sx={{ py: 1.5, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="subtitle2" fontWeight="medium">Memory Load</Typography>
            </Box>
            <Typography 
              variant="h4" 
              color={
                (metrics?.memory_load ?? 0) > 0.8 ? "error" : 
                (metrics?.memory_load ?? 0) > 0.5 ? "warning" : "success"
              } 
              fontWeight="bold" 
              align="center"
            >
